...
public class BookApplication {
    public static void main(String[] args) throws ClassNotFoundException {
        String db_conn = "jdbc:sqlserver://DESKTOP-FORO49H\\SQLEXPRESS:1433;"
...
//            Book book1 = new Book();
//            book1.setId(8);
//            book1.setTitle("capbo");
//            bookService.updateBook(book1, statement);
//            List<Book> bookList = bookService.findAll(statement);
//            bookList.forEach(System.out::println);
            //TODO: Find By Title
//            List<Book> bookList1 = bookService.searchBookByName("bo tran", statement);
//            bookList1.forEach(System.out::println);
            //TODO: Delete Book By Name
//            List<Book> bookList = bookService.deleteBookByName("shin cau be but chi", statement);
//            bookList.forEach(System.out::println);
